...
# Database configuration: Uses DATABASE_URL if present (Render/Railway), otherwise falls back to local MySQL
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'SwipeCollab <yourgmail@gmail.com>')
